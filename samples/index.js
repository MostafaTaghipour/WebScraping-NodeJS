...
/**
 * Proxy
 * fore example: http://localhost:3000/samples/proxy?url=developer.android.com
 */
...
/**
 * IMDB
 * for example : http://localhost:3000/samples/movie/tt0111161
 */
...
/**
 * Live Score
 * for example: http://localhost:3000/samples/league/football/italy/serie-a
 */
router.get("/league/:sport/:country/:league", async (req, res) => {
 ...
 */
router.get("/map/:lat/:lng", async (req, res) => {
